...
```no-highlight
GET /api/plugins/netbox-napalm-plugin/napalmplatformconfig/1/napalm/?method=get_environment
...
```
$ curl "http://localhost/api/plugins/netbox-napalm-plugin/napalmplatformconfig/1/napalm/?method=get_environment" \
...
```no-highlight
GET /api/plugins/netbox-napalm-plugin/napalmplatformconfig/1/napalm/?method=get_ntp_servers&method=get_ntp_peers
